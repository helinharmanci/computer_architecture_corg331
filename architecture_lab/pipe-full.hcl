...
####################################################################
#I determined the parameter orders of alu, make isubq a valid instruction for Fetch decode #exectute, I changed the flags according toı the result. Since I'm using add more than sub, i #made this instruction interpreted as an add operation 
...
word alufun = [
	#E_icode in { IISUBQ }:ALUSUB; 
	E_icode == IOPQ : E_ifun;
	1 : ALUADD;
];

## Should the condition codes be updated?
bool set_cc =  E_icode in { IISUBQ } ||( E_icode in { IOPQ } &&
